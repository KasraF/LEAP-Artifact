...
const extractEditorSrcTask = task.define('extract-editor-src', () => {
	...
	const leap = 'src/vs/editor/contrib/leap/browser/';
	...
	fs.mkdirSync(leap + 'local');
	fs.copyFileSync(leap + 'LeapUtils.ts', leap + 'local/LeapUtils.ts');
	...
	fs.unlinkSync(leap + 'LeapUtils.ts');
	fs.copyFileSync(leap + 'remote/LeapUtils.ts', leap + 'LeapUtils.ts');
	...
	fs.copyFileSync(rtv + 'RTVUtils.ts', 'out-editor-src/vs/editor/contrib/rtv/browser/RTVUtils.ts');
	fs.copyFileSync(leap + 'LeapUtils.ts', 'out-editor-src/vs/editor/contrib/leap/browser/LeapUtils.ts');
	...
	fs.unlinkSync(leap + 'LeapUtils.ts');
	fs.copyFileSync(leap + 'local/LeapUtils.ts', leap + 'LeapUtils.ts');
	fs.unlinkSync(leap + 'local/LeapUtils.ts');
	fs.rmdirSync(leap + 'local');
});
